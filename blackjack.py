...
if __name__ == '__main__':
    reset_screen()
    print(f"\n\n\tJ E F F' S   B L A C K J A C K   G A M E  - A Python Coding Exercise"
          f"\n\t"
    ...
    while count_chips(player_obj_lst):
        ...
        if count_chips(player_obj_lst):
            ...
            if num_players == 1:
                ...
                print(f"\n\tHey, {player_obj_lst[1].name} and {player_obj_lst[2].name}, thanks"
                      f"\n\tfor playing Jeff's blackjack game!")
            else:
                print(
                    f"\n\tHey, {player_obj_lst[1].name} and {player_obj_lst[2].name}, and {player_obj_lst[3].name},"
                    f"\n\tthanks for playing Jeff's blackjack game!")
            print()
